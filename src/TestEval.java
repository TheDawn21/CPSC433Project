...
public class TestEval {
    public static void main(String[] args) {
        Event game1 = new Event("game1", "CMSA", "U12", "T1", 1, true);
        Event game2 = new Event("game2", "CMSA", "U15", "T1", 9, true);
        Event game3 = new Event("game3", "CMSA", "U19", "T1", 1, true);
        Event game4 = new Event("game4", "CMSA", "U16", "T1", 0, true);
        Event prac1 = new Event("prac1", "CMSA", "U13", "T1", 2, false);
        Slot gSlot1 = new Slot("MO", 1800, 1900, 0, 0, false);
        Slot gSlot2 = new Slot("TU", 1100, 1230, 1, 0, false);
        Slot gSlot3 = new Slot("TU", 1830, 2000, 1, 0, false);
        Slot pSlot1 = new Slot("TU", 900, 1000, 2, 0, false);
        Slot pSlot2 = new Slot("TU", 1000, 1100, 2, 0, false);
